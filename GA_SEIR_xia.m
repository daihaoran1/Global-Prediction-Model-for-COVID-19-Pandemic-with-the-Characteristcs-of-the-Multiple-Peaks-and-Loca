...
Nh = 210867954; %总人口  美国2020年人口326766748；英国66573504；德国82293457；西班牙46397452；印度1354051854；俄罗斯人口143964709；墨西哥130759074；巴西210867954；

%给各种群变量分配内存
S = zeros(1,t);E = zeros(1,t);A = zeros(1,t);I = zeros(1,t);ID = zeros(1,t);R = zeros(1,t);EdConcount = zeros(1,t);

C = xlsread('印度-疫情数据.xlsx','4'); %数据   重新跑一遍
...
[c, y] = SEIR_Country_xia(C,result(1,:),pop); %返回的y是就是每日新增感染人数，c就是截止到当天的所有人群数和一些参数，用于带入到下一步计算中pop   
